<footer class="bg-gray-900 text-gray-300 py-12">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-24">
    <!-- About / Logo -->
    <div>
      ...
      <div class="flex space-x-4 mt-4">
        <a href="" aria-label="Youtube" target="_blank" class="hover:text-white text-xl">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-24 h-24 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Quick Links -->
    <div>
      <h3 class="text-4xl lg:text-xl font-semibold mb-4 text-white"><?php dict('quick-links') ?></h3>
      <ul class="space-y-2 text-3xl lg:text-sm">
    ...
    <!-- Contact Info -->
    <div>
      <h3 class="text-4xl lg:text-xl font-semibold mb-4 text-white"><?php dict('contact') ?></h3>
      <ul class="space-y-2 text-3xl lg:text-sm">
  ...
  <div class="mt-10 text-center text-gray-500 text-xl lg:text-xs">
