...
function get_content() {
    $dict_products = get_dict_products();
    $banner = $dict_products['banner'];
    $items = $dict_products['items'];
    ...
    <div class="bg-gray-100">
        ...
        <nav class="grid grid-cols-1 lg:grid-cols-3 items-stretch py-16 px-32 gap-16">
