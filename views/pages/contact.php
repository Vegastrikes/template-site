    ...
    <section class="bg-gray-100 pb-8">
        <div class="relative">
            ...
            <div class="absolute inset-0 bg-black/50 flex items-center justify-center text-white text-center p-6">
                <h1 class="text-3xl font-bold"><?php dict('contact')?></h1>
            </div>
        </div>

        <div class="p-8 lg:p-16">
            <!-- Contact Info Priority -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-12 text-center mb-12 lg:mb-20">
                <div class="p-6 bg-gray-50 rounded-lg shadow hover:shadow-md transition border borber-blue-900">
                    <h2 class="text-xl font-semibold mb-2 text-blue-900"><?php dict('email')?></h2>
                    <a href="mailto:company@engineering.com" class="text-gray-600">company@engineering.com</a>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow hover:shadow-md transition border borber-blue-900">
                    <h2 class="text-xl font-semibold mb-2 text-blue-900"><?php dict('working-hours')?></h2>
                    <p class="leading-relaxed text-gray-600">
                        <?php dict('work-days')?>: 9:00 – 17:00<br />
                    </p>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow hover:shadow-md transition border borber-blue-900">
                    <h2 class="text-xl font-semibold mb-2 text-blue-900"><?php dict('phone')?></h2>
                    <a href="tel:+900001112233" class="text-gray-600">+90 000 111 2233</a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12">
                ...
                <div class="bg-gray-50 rounded-lg shadow p-6 border borber-blue-900">
                    <h3 class="text-xl font-semibold mb-4 text-blue-900"><?php dict('address-1')?></h3>
                    <address class="not-italic text-gray-700 mb-6 leading-relaxed">
                        Ankara<br />
                        Ankara<br />
                        Ankara
                    </address>
                ...
                <!-- Address 2 -->
                <div class="bg-gray-50 rounded-lg shadow p-6 border borber-blue-900">
                    <h3 class="text-xl font-semibold mb-4 text-blue-900"><?php dict('address-2')?></h3>
                    <address class="not-italic text-gray-700 mb-6 leading-relaxed">
                        Eskişehir<br />
                        Eskişehir<br />
                        Eskişehir
